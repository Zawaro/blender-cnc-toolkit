import bpy
from . import VERSION_STRING, _is_rendering
...
class VIEW3D_PT_cc_toolkit(bpy.types.Panel):
  ...
  def _draw_active(self, layout, props, context):
    ...
    is_rendering = bool(CNC_OT_render_shadow._queue) or _is_rendering
...
class VIEW3D_PT_cc_toolkit_options(bpy.types.Panel):
  bl_label = "Options"
  bl_space_type = "VIEW_3D"
  bl_region_type = "UI"
  bl_category = "C&C Toolkit"
  ...
  def draw(self, context):
    layout = self.layout
    props = context.scene.cc_toolkit
    layout.enabled = props.template_generated


class VIEW3D_PT_cc_toolkit_denoise(bpy.types.Panel):
  bl_label = "Denoise"
  bl_parent_id = "VIEW3D_PT_cc_toolkit_options"
  bl_space_type = "VIEW_3D"
  bl_region_type = "UI"
  bl_category = "C&C Toolkit"
  bl_options = {"DEFAULT_CLOSED"}
  ...
  def draw(self, context):
    ...
    props = context.scene.cc_toolkit
    layout.enabled = props.template_generated
    layout.prop(props, "denoise_composite")
    layout.prop(props, "denoise_render")
