# variant-compatibility Specification

## Purpose
Deliberate behavior differences between the HiFive, Eevee Next, and CyclesX variants across engine mapping, compositor APIs, world setup, holdouts, denoise, and packaging. Terms: Engine, Variant, Render type, Shadow catcher.
## Requirements
