# render-type-visibility Specification

## Purpose
Which Render planes, holdout collection, and sun are visible for each Render type. Terms: Render type, Render plane, Shadow plane / Holdout plane.
## Requirements
