# addon-lifecycle Specification

## Purpose
Registration and unregistration of toolkit classes, scene properties, the crop-canvas monitor handler, the bundled guide text, and version reporting. Terms: `_CNC_` prefix, Crop canvas.
## Requirements
