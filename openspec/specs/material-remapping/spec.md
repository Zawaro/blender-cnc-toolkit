# material-remapping Specification

## Purpose
Adding, removing, and clearing Remap material entries and wiring the remap into the compositor via Cryptomatte. Terms: Remap material, Cryptomatte, Compositor tree.
## Requirements
